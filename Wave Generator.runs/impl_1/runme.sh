...
HD_PWD='G:/Documents/ECE_4305/SquareWaveGenerator4/Wave Generator/Wave Generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareWave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SquareWave.tcl -notrace
