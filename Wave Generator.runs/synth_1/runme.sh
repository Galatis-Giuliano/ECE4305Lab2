...
HD_PWD='G:/Documents/ECE_4305/SquareWaveGenerator4/Wave Generator/Wave Generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SquareWave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SquareWave.tcl
